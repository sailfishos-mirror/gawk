...
do_dump_node(int nargs)
{
	...
	fprintf(fp, "%zu\tarray_base\t%zu\n", offsetof(NODE, array_base), sizeof(n.array_base));
	fprintf(fp, "%zu\tarray_capacity\t%zu\n", offsetof(NODE, array_capacity), sizeof(n.array_capacity));
	fprintf(fp, "%zu\tarray_funcs\t%zu\n", offsetof(NODE, array_funcs), sizeof(n.array_funcs));
	fprintf(fp, "%zu\tarray_size\t%zu\n", offsetof(NODE, array_size), sizeof(n.array_size));
	fprintf(fp, "%zu\tbuckets\t%zu\n", offsetof(NODE, buckets), sizeof(n.buckets));
	fprintf(fp, "%zu\tcode_ptr\t%zu\n", offsetof(NODE, code_ptr), sizeof(n.code_ptr));
	fprintf(fp, "%zu\tcomment_type\t%zu\n", offsetof(NODE, comment_type), sizeof(n.comment_type));
	fprintf(fp, "%zu\tcur_idx\t%zu\n", offsetof(NODE, cur_idx), sizeof(n.cur_idx));
	fprintf(fp, "%zu\tdup_ent\t%zu\n", offsetof(NODE, dup_ent), sizeof(n.dup_ent));
	fprintf(fp, "%zu\telemnew_parent\t%zu\n", offsetof(NODE, elemnew_parent), sizeof(n.elemnew_parent));
	fprintf(fp, "%zu\telemnew_vname\t%zu\n", offsetof(NODE, elemnew_vname), sizeof(n.elemnew_vname));
	fprintf(fp, "%zu\tflags\t%zu\n", offsetof(NODE, flags), sizeof(n.flags));
	fprintf(fp, "%zu\tfor_array\t%zu\n", offsetof(NODE, for_array), sizeof(n.for_array));
	fprintf(fp, "%zu\tfor_list\t%zu\n", offsetof(NODE, for_list), sizeof(n.for_list));
	fprintf(fp, "%zu\tfor_list_size\t%zu\n", offsetof(NODE, for_list_size), sizeof(n.for_list_size));
	fprintf(fp, "%zu\tfparms\t%zu\n", offsetof(NODE, fparms), sizeof(n.fparms));
	...
	fprintf(fp, "%zu\torig_array\t%zu\n", offsetof(NODE, orig_array), sizeof(n.orig_array));
	fprintf(fp, "%zu\tparam\t%zu\n", offsetof(NODE, param), sizeof(n.param));
	fprintf(fp, "%zu\tparam_cnt\t%zu\n", offsetof(NODE, param_cnt), sizeof(n.param_cnt));
	fprintf(fp, "%zu\tparent_array\t%zu\n", offsetof(NODE, parent_array), sizeof(n.parent_array));
	fprintf(fp, "%zu\tprev_array\t%zu\n", offsetof(NODE, prev_array), sizeof(n.prev_array));
	fprintf(fp, "%zu\tprev_frame_size\t%zu\n", offsetof(NODE, prev_frame_size), sizeof(n.prev_frame_size));
	fprintf(fp, "%zu\tre_cnt\t%zu\n", offsetof(NODE, re_cnt), sizeof(n.re_cnt));
	fprintf(fp, "%zu\tre_exp\t%zu\n", offsetof(NODE, re_exp), sizeof(n.re_exp));
	fprintf(fp, "%zu\tre_flags\t%zu\n", offsetof(NODE, re_flags), sizeof(n.re_flags));
	fprintf(fp, "%zu\tre_reg\t%zu\n", offsetof(NODE, re_reg), sizeof(n.re_reg));
	fprintf(fp, "%zu\tre_text\t%zu\n", offsetof(NODE, re_text), sizeof(n.re_text));
	fprintf(fp, "%zu\treti\t%zu\n", offsetof(NODE, reti), sizeof(n.reti));
	fprintf(fp, "%zu\trnode\t%zu\n", offsetof(NODE, rnode), sizeof(n.rnode));
	fprintf(fp, "%zu\tstack\t%zu\n", offsetof(NODE, stack), sizeof(n.stack));
	fprintf(fp, "%zu\tstfmt\t%zu\n", offsetof(NODE, stfmt), sizeof(n.stfmt));
	fprintf(fp, "%zu\tstlen\t%zu\n", offsetof(NODE, stlen), sizeof(n.stlen));
	fprintf(fp, "%zu\tstptr\t%zu\n", offsetof(NODE, stptr), sizeof(n.stptr));
#ifdef HAVE_MPFR
	fprintf(fp, "%zu\tstrndmode\t%zu\n", offsetof(NODE, strndmode), sizeof(n.strndmode));
#endif
	fprintf(fp, "%zu\ttable_size\t%zu\n", offsetof(NODE, table_size), sizeof(n.table_size));
	fprintf(fp, "%zu\ttype\t%zu\n", offsetof(NODE, type), sizeof(n.type));
	fprintf(fp, "%zu\ttyped_re\t%zu\n", offsetof(NODE, typed_re), sizeof(n.typed_re));
	fprintf(fp, "%zu\tvalref\t%zu\n", offsetof(NODE, valref), sizeof(n.valref));
	fprintf(fp, "%zu\tvar_assign\t%zu\n", offsetof(NODE, var_assign), sizeof(n.var_assign));
	fprintf(fp, "%zu\tvar_update\t%zu\n", offsetof(NODE, var_update), sizeof(n.var_update));
	fprintf(fp, "%zu\tvar_value\t%zu\n", offsetof(NODE, var_value), sizeof(n.var_value));
	fprintf(fp, "%zu\tvname\t%zu\n", offsetof(NODE, vname), sizeof(n.vname));
	fprintf(fp, "%zu\twstlen\t%zu\n", offsetof(NODE, wstlen), sizeof(n.wstlen));
	fprintf(fp, "%zu\twstptr\t%zu\n", offsetof(NODE, wstptr), sizeof(n.wstptr));
	fprintf(fp, "%zu\txarray\t%zu\n", offsetof(NODE, xarray), sizeof(n.xarray));
